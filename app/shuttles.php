...
<body id="page-top">
            ...
            <div >
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="text-primary m-0 font-weight-bold">Upcoming Shuttles</h6>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="item-1-1-tab" data-toggle="tab" role="tab" aria-controls="item-1-1" aria-selected="true" href="#item-1-1" style="font-size: 13px;color: rgb(57,181,74);">Makumbura</a></li>
                                <li class="nav-item"><a class="nav-link" id="item-1-2-tab" data-toggle="tab" role="tab" aria-controls="item-1-2" aria-selected="false" href="#item-1-2" style="font-size: 13px;color: rgb(57,181,74);">NSBM</a></li>
                            </ul>
                        </div>
    ...
    <div class="footer">
        <ul>
          ...
          <a href="shuttles.php"><li class="active">
